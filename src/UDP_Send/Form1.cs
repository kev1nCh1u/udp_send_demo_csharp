    ...
    public partial class Form1 : Form
    {
        ...
        **********************************************************************************************************************************/
        private void Btn_Send7(object sender, EventArgs e)
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            String AAA = "Mr;1,0,2.46556,-4.44588,1.66535,diff,1,0.5,ivam_3F;2,1,-0.09,0.49,2.02,diff,0,0.5,ivam_3F;3,3,-1.18,-0.41,-3.01,diff,0,0.5,ivam_3F,2;E"; //back home
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            pushdata = Encoding.UTF8.GetBytes(AAA); //把要送出的資料轉成byte型態
            Server.SendTo(pushdata, remoteIP); //送出的資料跟目的
        }
